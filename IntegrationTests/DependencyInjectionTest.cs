...
//            Assert.AreEqual("unique-urls", optionsBuilder.Options.ContainerName);

//            optionsBuilder.UseContainerName("test");
//            Assert.AreEqual("test", optionsBuilder.Options.ContainerName);

//            optionsBuilder.UseDefaultStorageAccount();
//            Assert.AreEqual(null, optionsBuilder.Options.ConnectionString);

//            optionsBuilder.UseStorageAccount("test");
//            Assert.AreEqual("test123", optionsBuilder.Options.ConnectionString);

//            optionsBuilder.UseStorageAccount("test-22");
//            Assert.AreEqual("test-22", optionsBuilder.Options.ConnectionString);
//        }
...
//            Assert.AreEqual("unique-urls", options.Value.ContainerName);
//        }
